    ...
    <el-dialog v-model="dialogFormVisible" title="新增培训" align-center center class="" width="430"
      ...
      <el-form :model="state.formData" class="" status-icon :rules="rules" ref="ruleFormRef">
        <el-row :gutter="24">
          ...
          <el-col :span="24">
            <el-form-item prop="planState" size="large" label="培训状态：" label-width="130">
              <el-select v-model="state.formData.planState" style="width:450px;;margin-left: 10px"
                         placeholder="请选择培训状态"
                         clearable>
                <el-option label="报名中" value="报名中"/>
                <el-option label="已报名" value="已报名"/>
    ...
    <el-dialog v-model="dialogUpdateVisible" title="修改计划" align-center center class="" width="400"
      ...
      <el-form :model="state.updateData" class="" status-icon :rules="rules" ref="ruleFormRef">
        <el-row :gutter="24">
          ...
          <el-col :span="24">
            <el-form-item prop="planState" size="large" label="培训状态：" label-width="130">
              <el-select v-model="state.updateData.planState" style="width:450px;;margin-left: 10px"
                         placeholder="请选择培训状态"
                         clearable>
                <el-option label="报名中" value="报名中"/>
                <el-option label="已报名" value="已报名"/>
